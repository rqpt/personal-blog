    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'seo' => \ArchTech\SEO\SEOManager::class,
    ...
    override(\config(), map([
            ...
            'blade-icons.attributes.width' => 'integer',
            'blade-icons.attributes.height' => 'integer',
            ...
            'filesystems.disks.tmp.throw' => 'boolean',
            ...
            'markdown.commonmark.unordered_list_markers' => 'string',
            ...
            'markdown.default_attributes.League\CommonMark\Extension\CommonMark\Node\Inline\Link.@mouseenter' => 'string',
            'markdown.default_attributes.League\CommonMark\Extension\CommonMark\Node\Inline\Link.x-intersect:enter' => 'string',
            'markdown.default_attributes.League\CommonMark\Extension\CommonMark\Node\Inline\Link.x-intersect:leave' => 'string',
            'markdown.heading_permalink.insert' => 'string',
            'markdown.heading_permalink.symbol' => 'string',
            'markdown.table_of_contents.min_heading_level' => 'integer',
            'markdown.table_of_contents.max_heading_level' => 'integer',
            ...
            'third-party-api.random_markdown.url' => 'string',
            'third-party-api.openai.url' => 'string',
            'third-party-api.openai.api_key' => 'NULL',
            'tinker.commands' => 'array',
            'tinker.alias' => 'array',
            'tinker.dont_alias' => 'string',
            'torchlight.cache' => 'NULL',
            'torchlight.cache_seconds' => 'integer',
            'torchlight.theme.dark' => 'string',
            'torchlight.theme.light' => 'string',
            'torchlight.token' => 'NULL',
            'torchlight.blade_components' => 'boolean',
            'torchlight.host' => 'string',
            'torchlight.tab_width' => 'integer',
            'torchlight.snippet_directories' => 'string',
            'torchlight.options.lineNumbers' => 'boolean',
            'cors.paths' => 'string',
...
'blade-icons.sets.default.attributes','blade-icons.class','blade-icons.attributes.width','blade-icons.attributes.height','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','editor.options','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.tmp.driver','filesystems.disks.tmp.root','filesystems.disks.tmp.throw','filesystems.links./var/www/html/public/storage',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','markdown.views','markdown.extensions',
...
'markdown.max_nesting_level','markdown.slug_normalizer.max_length','markdown.slug_normalizer.unique','markdown.default_attributes.League\\CommonMark\\Extension\\CommonMark\\Node\\Inline\\Link.@mouseenter','markdown.default_attributes.League\\CommonMark\\Extension\\CommonMark\\Node\\Inline\\Link.x-intersect:enter',
'markdown.default_attributes.League\\CommonMark\\Extension\\CommonMark\\Node\\Inline\\Link.x-intersect:leave','markdown.heading_permalink.insert','markdown.heading_permalink.symbol','markdown.table_of_contents.min_heading_level','markdown.table_of_contents.max_heading_level',
...
'octane.garbage','octane.max_execution_time','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','third-party-api.random_markdown.url','third-party-api.openai.url',
'third-party-api.openai.api_key','tinker.commands','tinker.alias','tinker.dont_alias','torchlight.cache',
'torchlight.cache_seconds','torchlight.theme.dark','torchlight.theme.light','torchlight.token','torchlight.blade_components',
'torchlight.host','torchlight.tab_width','torchlight.snippet_directories','torchlight.options.lineNumbers','cors.paths',
'cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers','cors.exposed_headers',
'cors.max_age','cors.supports_credentials','services.postmark.token','services.ses.key','services.ses.secret',
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','auth.defaults.guard',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','view.paths','view.compiled',
...
'cache.stores.dynamodb.table','cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','broadcasting.default',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','mail.default',
...
'logging.channels.deprecations.handler','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','queue.default',
...
'queue.failed.database','queue.failed.table','concurrency.default','hashing.driver','hashing.bcrypt.rounds',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','blade-fontawesome.brands.prefix','blade-fontawesome.brands.fallback','blade-fontawesome.brands.class',
'blade-fontawesome.brands.attributes','blade-fontawesome.regular.prefix','blade-fontawesome.regular.fallback','blade-fontawesome.regular.class','blade-fontawesome.regular.attributes',
'blade-fontawesome.solid.prefix','blade-fontawesome.solid.fallback','blade-fontawesome.solid.class','blade-fontawesome.solid.attributes','blade-fontawesome.duotone.prefix',
'blade-fontawesome.duotone.fallback','blade-fontawesome.duotone.class','blade-fontawesome.duotone.attributes','blade-fontawesome.light.prefix','blade-fontawesome.light.fallback',
'blade-fontawesome.light.class','blade-fontawesome.light.attributes','blade-fontawesome.thin.prefix','blade-fontawesome.thin.fallback','blade-fontawesome.thin.class',
'blade-fontawesome.thin.attributes','blade-fontawesome.sharp-light.prefix','blade-fontawesome.sharp-light.fallback','blade-fontawesome.sharp-light.class','blade-fontawesome.sharp-light.attributes',
'blade-fontawesome.sharp-regular.prefix','blade-fontawesome.sharp-regular.fallback','blade-fontawesome.sharp-regular.class','blade-fontawesome.sharp-regular.attributes','blade-fontawesome.sharp-solid.prefix',
'blade-fontawesome.sharp-solid.fallback','blade-fontawesome.sharp-solid.class','blade-fontawesome.sharp-solid.attributes','blade-fontawesome.sharp-duotone-solid.prefix','blade-fontawesome.sharp-duotone-solid.fallback',
'blade-fontawesome.sharp-duotone-solid.class','blade-fontawesome.sharp-duotone-solid.attributes','blade-fontawesome.sharp-thin.prefix','blade-fontawesome.sharp-thin.fallback','blade-fontawesome.sharp-thin.class',
'blade-fontawesome.sharp-thin.attributes','blade-fontawesome.custom.prefix','blade-fontawesome.custom.fallback','blade-fontawesome.custom.class','blade-fontawesome.custom.attributes',
...
'sitemap.chrome_binary_path','sitemap.crawl_profile','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'signed','throttle','verified','heal-url',);
...
'pages.index','volt-livewire::wire-nav','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination::tailwind','seo::components.extensions.favicon','seo::components.extensions.twitter','seo::components.meta','sitemap::image',
