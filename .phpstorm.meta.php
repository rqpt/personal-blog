...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'torchlight.snippet_directories' => 'array',
...
'octane.garbage','octane.max_execution_time','sanctum.stateful','sanctum.guard','sanctum.expiration',
'sanctum.token_prefix','sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','session.driver',
...
'third-party-api.random_markdown.url','third-party-api.openai.url','third-party-api.openai.api_key','tinker.commands','tinker.alias',
'tinker.dont_alias','torchlight.cache','torchlight.cache_seconds','torchlight.theme.dark','torchlight.theme.light',
'torchlight.token','torchlight.blade_components','torchlight.host','torchlight.tab_width','torchlight.snippet_directories',
'torchlight.options.lineNumbers','cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns',
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','services.postmark.token',
...
'services.slack.notifications.channel','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'view.paths','view.compiled','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'cache.prefix','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'broadcasting.connections.null.driver','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'mail.markdown.theme','mail.markdown.paths','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','logging.channels.deprecations.driver','logging.channels.deprecations.handler','database.default','database.connections.sqlite.driver',
...
'database.redis.cache.port','database.redis.cache.database','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'debugbar.debug_backtrace_limit','blade-fontawesome.brands.prefix','blade-fontawesome.brands.fallback','blade-fontawesome.brands.class','blade-fontawesome.brands.attributes',
...
'blade-fontawesome.custom.prefix','blade-fontawesome.custom.fallback','blade-fontawesome.custom.class','blade-fontawesome.custom.attributes','sitemap.guzzle_options.cookies',
